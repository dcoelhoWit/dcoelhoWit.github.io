...
function updateHintsVisibility() {
  hint1.style.opacity = (score / 100).toFixed(5)
  hint2.style.opacity = (score / 300).toFixed(5)
  hint3.style.opacity = (score / 900).toFixed(5)
  hint4.style.opacity = (score / 1500).toFixed(5) 
}
